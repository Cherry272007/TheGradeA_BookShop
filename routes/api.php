...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // --- User Self-Management (Profile & Personal Orders) ---
    Route::prefix('me')->group(function () {
        ...
        Route::get('/contacts', [ContactController::class, 'userIndex']);
    });
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::get('/about',     [AboutController::class, 'adminIndex']); 
        ...
        Route::get('/contacts',             [ContactController::class, 'index']);      // List messages
        Route::get('/contacts/stats',       [ContactController::class, 'stats']);      // Dashboard stats
        Route::get('/contacts/{id}',        [ContactController::class, 'show']);       // View message (marks as read)
        Route::post('/contacts/{id}/reply', [ContactController::class, 'reply']);      // Submit actual reply text
        Route::delete('/contacts/{id}',     [ContactController::class, 'destroy']);   // Delete message
    });
});